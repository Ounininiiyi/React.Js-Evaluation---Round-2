...
function Header() {
  return (
    <Navbar expanded='lg' className='nav-bg'>
        <Container>
            ...
            <Navbar.Collapse id='navbar'>
                <Nav className='me-auto'>
                    <Nav.Link herf='#find'> Find Work</Nav.Link>
                    <Nav.Link herf='#find'> Find Talent</Nav.Link>
                    <Nav.Link herf='#articles'> Articles</Nav.Link>
                    <Nav.Link herf='#about'> About Us</Nav.Link>
                    <Nav.Link herf='#contact'> Contact Us</Nav.Link>
                </Nav>
            </Navbar.Collapse>
            <div className='extra-nav'> 
                <Nav.Link className='login-link'>Log In</Nav.Link>
                <Nav.Link className='join-link'>
